...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b border-neutral-700">
      ...
      <main className="px-4 py-12">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <div className="bg-card border border-neutral-700 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
          ...
          <div className="space-x-4">
            ...
            <Link href="/auth">
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-8 border-neutral-700 hover:bg-accent hover:text-accent-foreground bg-transparent"
              >
                Sign In
              </Button>
            </Link>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {featuredCharacters.map((character) => (
              <Card
                key={character.id}
                className="bg-card border-neutral-700 hover:border-primary/50 transition-colors cursor-pointer group"
              >
          ...
          <div className="text-center mt-8">
            <Link href="/auth">
              <Button
                variant="outline"
                className="border-neutral-700 hover:bg-accent hover:text-accent-foreground bg-transparent"
              >
                View All Characters
              </Button>
            </Link>
